...
# Third signal - write your own code HERE
# x3 = ...
...
# ax[0].grid()                       # add grid
ax[0].axis([ -5, 15, -0.1, 1.1])  # define the x and y axis of the plot
ax[0].set_xticks(n+1)
...
#
# Third DTS - write your own code for plotting the third signal HERE
#
...
savefig('mysignal_assignment06.png')
